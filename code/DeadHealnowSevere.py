# -*- coding: utf-8 -*-
"""
Created on Sun Jun 21 10:31:44 2020
...
#plt.title('死亡-治愈-重症病例数曲线图',font)
plt.plot(list_date_x,list(data_new1[0]),label='New deaths per day',color='r',alpha=0.5)
plt.plot(list_date_x,list(data_new1[1]),label='Daily new cured cases',color='b',alpha=0.7)
