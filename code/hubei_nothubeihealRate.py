# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 18:55:33 2020
...
list_nothubei_healRate = list(data1['healRate'])
...
#plt.title('湖北与非湖北地区治愈率对比曲线图',font)
plt.plot(list_date_x,list_hubei_healRate,label='Hubei cure rate',color='r',alpha=0.5)
plt.plot(list_date_x,list_nothubei_healRate,label='Non-Hubei cure rate',color='b',alpha=0.7)
plt.xlabel('Date',font)
plt.ylabel('Cure rate %',font)
...
#plt.savefig('img/湖北省-非湖北省治愈率对比曲线图.jpg')
plt.show()